...
print(poll_results.get_voter_answer_single("Q2", voter_index=300))

print("\n == Q3: approval question ==\n")  
print(poll_results.get_voter_answer_multiple("Q3", voter_index=300))
print(poll_results.get_voter_answer_approval("Q3", voter_index=300))

print("\n == Q6: rank question ==\n")   
print(poll_results.get_voter_answer_multiple("Q6", voter_index=300))
